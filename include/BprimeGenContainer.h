...
class BprimeGenContainer{
 public:
  BprimeGenContainer(){topHad.SetPxPyPzE(0,0,0,0);topLep.SetPxPyPzE(0,0,0,0);wHad.SetPxPyPzE(0,0,0,0);wLep.SetPxPyPzE(0,0,0,0);bprime.SetPxPyPzE(0,0,0,0);}
 ...
 private:  
  LorentzVector wLep, wHad, topHad, topLep, bprime;
};
