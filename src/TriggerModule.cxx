...
TriggerModule::TriggerModule(Context& ctx){
  ...
  muonTrigger->addAndSelection(make_uvec(make_unique<RelIso>(reliso_val),make_unique<TwoDCut>(deltarmin,ptrel),make_unique<HTLepSelection>(ctx,HTLep_val),make_unique<METSelection>(MET_val),make_unique<NJetSelection>(2,-1,jet)),"Sel_2D_Iso");
  ...
  muonTrigger->addAndSelection(make_uvec(make_unique<TwoDCut>(deltarmin,ptrel),make_unique<HTLepSelection>(ctx,HTLep_val),make_unique<METSelection>(MET_val),make_unique<NJetSelection>(2,-1,jet),make_unique<TriggerSelection>("HLT_Mu50_v*")),"HLT_Mu50_Sel_2DCut");
